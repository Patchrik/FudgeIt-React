...
namespace Fudge_It.Repositories
{
    public class TagRepository : ITagRepository
    {
        ...
        {
            return _context.Tag.Include(tag => tag.ExpenseTags).ThenInclude(expTag => expTag.Tag).Where(tag => tag.UserProfileId == userProfileId).OrderByDescending(tag => tag.CreatedDate).ToList();
